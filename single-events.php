	...
	<div class="content-area">
		...
		if( $urgency ){
			if( $urgency != 'off' ){
				...
				if( $urgency == 'urgency' ):
					?><div class="sofu sofu--type-urgency">
				...
				elseif( $urgency == 'available' ):
					?><div class="sofu sofu--type-available">
						<div class="sofu__title">A jegyek elérhetőek!</div>
						<div class="sofu__desc">Váltson belépőt az előadásra.</div>
						<div class="sofu__bar"><div class="sofu__bar-inner" style="width:<?php echo 20 + (floor((int)date("j") / ((int)date("t") / 19))); ?>%;"><div class="sofu__bar-stripe"></div></div></div>
					</div><br><?php
